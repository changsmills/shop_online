...
useEffect(() => {
  ...
  margin: isMobile ? '0' : '0 auto'
    ...
    <div className="left-content">
      ...
      <div className="product-description-section" style={{ marginTop: '24px' }}>
      ...
      {/* SEHEMU ZA STORE - ZINAONEKANA MOJA KWA MOJA KWENYE SIMU */}
      {isMobile && product.stores && (
        <div className="mobile-store-details" style={{ marginTop: '20px' }}>
          {/* Store Header Card */}
   ...
   {/* ================= UPANDE WA KULIA - STICKY SIDEBAR ================= */}
<aside className="right-sidebar" style={{ 
  ...
  <div style={{
    position: 'sticky',
    top: '80px', /* Badala ya 20px kuwa mbali na navbar */
    alignSelf: 'start',
    width: '100%'
  }}>
    <ProductInfo 
